  ...
  const renderDropzone = (index, type, fieldKey) => (
    ...
    >
      {({ getRootProps, getInputProps, isDragActive }) => (
        <div
          {...getRootProps()}
          className={`border-2 border-dashed relative rounded-lg p-5 w-full text-center cursor-pointer transition-colors duration-200 ${
            isDragActive
        ...
        <div className="flex flex-col gap-2 p-4">
          <div>
            <label className="md:text-base text-[16px]  text-[#555]">
              {t("profile.uploadDesc", { value: open?.label })}
