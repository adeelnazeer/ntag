    ...
    <div className="md:p-4 p-2 rounded-xl shadow pb-7">
      ...
      {loading ?
        ...
        <div className="overflow-x-auto">
          {data?.map((single) => (
            <div
              className="flex justify-between gap-8 p-2 border rounded-xl mt-3 items-center min-w-[600px]"
              key={single?.id}
            >
              <div className="flex gap-16 items-center">
                ...
                <div>
                  ...
                  <p className="text-secondary md:text-[18px] text-[13px] md:w-[240px] w-[109px] font-bold">
                    {single?.tag_price || ""}{" "}
