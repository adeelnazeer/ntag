const Services = () => {
  return (
    ...
    >
      ...
      <p className=" md:text-[18px] text-[16px]  font-medium">Introducing Name TAG: Your Identity, Evolved</p>
      <p className=" md:text-[18px] text-[16px] my-2">
        ...
        to launch Name TAG, a revolutionary service that lets you assign a unique, memorable name to your phone number!
      </p>
      <p className=" md:text-[18px] text-[16px]  font-medium pt-3">What is Name TAG?</p>
      <p className=" md:text-[18px] text-[16px] my-2">
        Name TAG is a virtual number service that allows you to choose a short, catchy name, nickname, or phrase
      ...
      <p className=" md:text-[18px] text-[16px] my-2">
        - Subscribe to Name TAG through our website.
      </p>
      <p className=" md:text-[18px] text-[16px] my-2">
        - Choose your desired Name TAG number (VIP, Golden, Silver, etc.) and pay the subscription fee
      </p>
      <p className=" md:text-[18px] text-[16px] my-2">
        - Use your Name TAG number to make calls, and the receiver will see your chosen name instead of your primary number
      </p>
      ...
      <p className=" md:text-[18px] text-[16px] my-2">
        - Manage your Name TAG service through our website, USSD, SMS, or mobile app
      </p>
      <p className=" md:text-[18px] text-[16px] my-2">
