              ...
              <div className="overflow-x-auto">
                <table className="min-w-full bg-white">
                  <thead className="bg-[#F6F7FB]">
                    <tr>
                      <th className="py-3 px-4 text-left text-xs text-[#7A798A]">TAG Number</th>
                      <th className="py-3 px-4 text-left text-xs text-[#7A798A]">Mobile Number</th>
                      <th className="py-3 px-4 text-left text-xs text-[#7A798A]">Registration Date</th>
                      <th className="py-3 px-4 text-left text-xs text-[#7A798A]">Status</th>
                      <th className="py-3 px-4 text-left text-xs text-[#7A798A]">Action</th>
                    </tr>
                  </thead>
                  <tbody>
